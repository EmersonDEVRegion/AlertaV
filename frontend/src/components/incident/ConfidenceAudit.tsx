  ...
  return (
    <details className="rounded-xl bg-slate-50 ring-1 ring-slate-200">
      <summary className="cursor-pointer list-none px-3 py-2.5 text-sm font-semibold text-slate-700 [&::-webkit-details-marker]:hidden">
        ...
        <span aria-hidden className="float-right text-slate-400">
          ▾
        </span>
      </summary>
      ...
      <div className="border-t border-slate-200 px-3 py-3">
        ...
        {ceiling && (
          <p className="mt-2.5 rounded-lg bg-amber-50 px-2.5 py-2 text-[11px] leading-snug text-amber-900 ring-1 ring-amber-200">
            {ceiling}
          </p>
        )}
